...
import { Target, FileText, Bookmark, Zap, UserCheck, User } from "lucide-react";
...
function LandingPage({ onGuest, onSignIn }) {
  return (
    <div style={{
...
export default function App() {
  ...
  if (!mode) {
    return <LandingPage onGuest={() => setMode("guest")} onSignIn={handleSignIn} />;
  }
